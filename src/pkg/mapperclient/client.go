...
func (c *Client) ServiceIntentsWithLabels(ctx context.Context, namespaces []string, labels []string) ([]ServiceIntentsWithLabelsServiceIntents, error) {
	res, err := ServiceIntentsWithLabels(ctx, c.client, namespaces, labels, false)
	if err != nil {
		return nil, err
	}
	return res.ServiceIntents, nil
...
func (c *Client) Intents(ctx context.Context, namespaces []string, labels []string, includeAllLabels bool) ([]IntentsIntentsIntent, error) {
	res, err := Intents(ctx, c.client, namespaces, labels, includeAllLabels)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListIntents(ctx context.Context, namespaces []string, withLabelsFilter bool, labels []string, includeAllLabels bool) ([]IntentsIntentsIntent, error) {
	if withLabelsFilter {
		intents, err := c.Intents(ctx, namespaces, labels, includeAllLabels)
